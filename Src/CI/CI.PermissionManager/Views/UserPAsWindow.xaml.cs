...
public partial class UserPAsWindow : Visual.Lib.Base.WindowBase
{
  readonly DB.Inventory.Models.InventoryContext _context = new(@"Server=mtUATsqldb;Database=Inventory;Trusted_Connection=True;");
