...
namespace RMSClient.Comm
{
    public class ServerSession
    {
        ...
        readonly RmsClientMainWindow m_mainForm;
        const int BufferSize = 1000;
        int m_received = 0;
        uint m_seqNo = 0;
        readonly ILogger<RmsClientMainWindow> _logger;

        public ServerSession(ILogger<RmsClientMainWindow> logger, RmsClientMainWindow form) => (_logger, m_mainForm) = (logger, form);
